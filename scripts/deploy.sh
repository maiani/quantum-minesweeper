...
gcloud run deploy "$SERVICE" \
  ...
  --set-env-vars "QMS_ENABLE_AUTH=${QMS_ENABLE_AUTH:-1},QMS_USER=${QMS_USER:-},QMS_PASS=${QMS_PASS:-},QMS_ADMIN_PASS=${QMS_ADMIN_PASS:-},QMS_BACKEND=${QMS_BACKEND:-stim},QMS_ENABLE_HELP=${QMS_ENABLE_HELP:-1},QMS_ENABLE_TUTORIAL=${QMS_ENABLE_TUTORIAL:-1},QMS_TUTORIAL_URL=${QMS_TUTORIAL_URL:-},QMS_BASE_URL=${QMS_BASE_URL:-}"
