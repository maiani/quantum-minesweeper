...
"""
Per-gate parity across all backends (Stim, Qiskit, chppy).
...
chppy and guards against any backend silently diverging.
"""
...
from qminesweeper.chppy_backend import ChppyState
...
def _chppy_expect(state: ChppyState, paulis: dict[int, str], n: int) -> float:
...
BACKENDS = {
    ...
    "chppy": (ChppyState, _chppy_expect),
}
